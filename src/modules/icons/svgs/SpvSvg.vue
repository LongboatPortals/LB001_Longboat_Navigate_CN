<template>
    <svg version="1.1" id="spv-svg" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 520 520" style="enable-background:new 0 0 520 520" xml:space="preserve">
        <path class="st3" d="M283.9 18.7C409.6 20 511.2 122.4 511.2 248.5S408.3 478.3 281.4 478.3 52.9 376.7 51.6 251V24.1c0-3 2.4-5.4 5.4-5.4h226.9z" style="opacity:.1;fill-rule:evenodd;clip-rule:evenodd;enable-background:new" id="Layer_1_00000142878812270592887230000012010088758394542750_"/>
        <g id="Layer_3">
            <circle class="st1" cx="376.6" cy="392.3" r="112.9" style=""/>
        ...
        <g id="Layer_2_00000047764361022986949340000004542032594432628117_">
            <circle class="st3" cx="393.6" cy="227.7" r="76.4" style="opacity:.35;enable-background:new"/>
