<template>
    <svg version="1.1" id="psn-svg" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 570 570" style="enable-background:new 0 0 570 570" xml:space="preserve">
        <g id="Layer_1_00000078029641532586155490000004817979436613993400_">
            <path class="st1" d="M279 556.4C130.4 555 10.3 434 10.3 285S131.9 13.5 281.8 13.5s269.9 120 271.4 268.7V551c0 3-2.4 5.4-5.4 5.4H279z" style="opacity:.1;fill-rule:evenodd;clip-rule:evenodd;enable-background:new"/>
        ...
        <g id="Layer_2_00000121246119117591721040000016033259381626628281_">
            ...
            <path class="st2" d="M168.6 187.1h243.8c.9 0 1.7.8 1.7 1.7V330c0 .9-.8 1.7-1.7 1.7H168.6c-.9 0-1.7-.8-1.7-1.7V188.8c0-1 .8-1.7 1.7-1.7z" style="opacity:.47;enable-background:new"/>
            <g style="opacity:.49">
