<template>
    <svg version="1.1" id="faq-svg" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 529 520" style="enable-background:new 0 0 529 520" xml:space="preserve" role="none">
        <g id="Layer_1_00000028320838830023681680000001842504767437265804_">
            <path class="st1" d="M496 257.5C494.7 131.7 392.3 30.2 266.3 30.2S36.5 133.1 36.5 260 138 488.5 263.8 489.8h226.9c3 0 5.4-2.4 5.4-5.4l-.1-226.9z" style="opacity:.1;fill-rule:evenodd;clip-rule:evenodd;enable-background:new"/>
            <circle class="st1" cx="403.5" cy="165" r="104.6" style="opacity:.1;enable-background:new"/>
