<template>
    <svg version="1.1" id="tim-svg" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 520 520" style="enable-background:new 0 0 520 520" xml:space="preserve" role="none">
        <g id="Layer_1_00000083069340881785780060000012257992767096364702_">
            <path class="path" d="M275.2 489.8C401 488.4 502.5 386.1 502.5 260S399.7 30.2 272.8 30.2 44.3 131.8 43 257.5v226.9c0 3 2.4 5.4 5.4 5.4h226.8z" style="opacity:.1;fill-rule:evenodd;clip-rule:evenodd;enable-background:new"/>
            <circle cx="396.5" cy="393.7" r="113.4" style="opacity:.1;enable-background:new"/>
        </g>
        <g id="Layer_2_00000038383375183441177220000017620747142998319018_">
            <path class="st1" d="M69.6 16.3h284c34.4 0 62.4 27.9 62.4 62.4v284c0 34.4-27.9 62.4-62.4 62.4h-284c-34.4 0-62.4-27.9-62.4-62.4v-284c0-34.5 28-62.4 62.4-62.4z" style=""/>
...
#tim-svg {
    .path{
        fill: $timeline-svg-primary-color;
    }
    .st1{
        opacity:0.2;
        fill: $timeline-svg-primary-color;
    ...
    .st3 {
        fill: $timeline-svg-secondary-color;
    }
